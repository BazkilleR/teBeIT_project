...
<body>
  <div class="bg-blue-gradient container m-auto h-screen gap-4 p-6">
    <div class="relative flex h-full w-full flex-col gap-4 overflow-y-auto rounded-2xl bg-white p-6">
      <a href="loginManager.php" class="bg-sky-gradient hover:bg-red-gradient absolute left-3 top-3 z-50 rounded-full"><img src="../src/img/back_icon.png" alt="back_icon" width="50" height="50" /></a>

...
<body>
  <div class="container m-auto h-screen gap-4 bg-blue-gradient p-6">
    <div class="flex h-full w-full flex-col gap-4 overflow-y-auto rounded-2xl bg-white p-6 relative">
      <a href="loginSale.php" class="absolute top-3 left-3 z-50 rounded-full bg-sky-gradient hover:bg-red-gradient"><img src="../src/img/back_icon.png" alt="back_icon" width="50" height="50"></a>
      ...
      <a href="addOrder.php" class="flex items-center justify-center rounded-xl bg-sky-gradient p-4 hover:bg-red-gradient"><img src="../src/img/plus.png" alt="plus.png" /></a>
    </div>
  </div>
</body>
